...
import 'mocha';
import { BLEAltBeacon, BLEAltBeaconBuilder, BLEUUID } from '../../../src';

describe('BLEAltBeacon', () => {
    describe('from manufacturer data', () => {
        const beacon = new BLEAltBeacon();
        const payload = new Uint8Array([
            2, 1, 6, 27, 255, 76, 0, 190, 172, 253, 165, 6, 147, 164, 226, 79, 177, 175, 207, 198, 235, 7, 100, 120, 37,
            139, 29, 11, 60, 200, 0, 22, 22, 170, 254, 16, 241, 3, 116, 105, 110, 121, 117, 114, 108, 0, 53, 55, 109,
            98, 98, 120, 50, 119, 0, 0, 0, 0, 0, 0, 0, 0,
        ]);
    ...
    describe('beacon id', () => {
        ...
        const payload = Uint8Array.from([
            0x02, 0x01, 0x06, 0x1b, 0xff, 0x4c, 0x00, 0xbe, 0xac, 0xab, 0x81, 0x90, 0xd5, 0xd1, 0x1e, 0x49, 0x41, 0xac,
